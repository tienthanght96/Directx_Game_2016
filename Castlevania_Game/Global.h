...
#define GL_RESOLUTION_384_512	133
//
...
extern int		G_MapWidth[2];			//count the tiles in map width, 1 tile 50px
extern int			G_MapHeight[2];			//count the tiles in map height, 1 tile 50px
